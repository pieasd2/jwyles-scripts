...
namespace HighVoltz
{
    public partial class MainForm : Form
    {
        ...
        public MainForm() {
            ...
            InitializeComponent();
            if (Directory.Exists(@"C:\Users\highvoltz\Desktop\Buddy\Projects\Professionbuddy\Professionbuddy\Profiles"))
            {
        ...
        void AddToActionTree(object action, TreeNode dest) {
            ...
            if (dest != null)
            {
                ...
                PrioritySelector ps = dest.Tag is If && !ignoreRoot ? (PrioritySelector)((If)dest.Tag).DecoratedChild :
                    (PrioritySelector)((Composite)dest.Tag).Parent;

                if (dest.Tag is If && !ignoreRoot)
                {
        ...
        TreeNode RecursiveCloning(TreeNode node) {
            ...
            if (node.Nodes != null)
            {
                ...
                {
                    PrioritySelector ps = (PrioritySelector)((If)newComp).DecoratedChild;
        ...
        public void InitActionTreeCallback() {
            ...
            foreach (IPBComposite composite in PB.CurrentProfile.Branch.Children)
            {
                ...
                if (composite is If)
                {
                    ActionTreeAddChildren(composite as If, node);
                }
        ...
        void ActionTreeAddChildren(If ds, TreeNode node) {
            foreach (IPBComposite child in ((PrioritySelector)ds.DecoratedChild).Children)
            {
                ...
                if (child is If)
                {
                    ActionTreeAddChildren(child as If, childNode);
                }
