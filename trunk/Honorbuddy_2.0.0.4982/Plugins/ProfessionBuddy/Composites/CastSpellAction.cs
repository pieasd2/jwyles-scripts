...
namespace HighVoltz.Composites
{
    ...
    public class CastSpellAction : PBAction
    {
        ...
        int calculateRepeat()
        {
            switch (RepeatType)
            {
                ...
                case RepeatCalculationType.Craftable:
                    return IsRecipe ? Util.CalculateRecipeRepeat(Recipe) : Repeat;
        ...
        {
            return new CastSpellAction() { Entry = this.Entry, Repeat = this.Repeat, ItemType = this.ItemType,
                RepeatType = this.RepeatType,ItemId = this.ItemId,CastOnItem = this.CastOnItem };
        }
